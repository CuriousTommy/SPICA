...
namespace SPICA.WinForms.Formats
{
    ...
    {
        public static H3D OpenAsH3D(ref StreamWriter outputFile, Stream Input, GFPackage.Header Header)
        {
            H3D Output;
            ...
            GFModelPack MdlPack = new GFModelPack(ref outputFile, Input);
            ...
            if (Header.Entries.Length > 3 && Header.Entries[3].Length >= 4)
            {
                ...
                if (MagicNum == 0x15041213)
                {
                    ...
                    GFTexture Tex = new GFTexture(ref outputFile, Reader);
